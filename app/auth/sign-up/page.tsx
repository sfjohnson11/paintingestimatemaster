      ...
      const { error } = await supabase.auth.signUp({
        ...
        options: {
          emailRedirectTo:
            ...
            `${window.location.origin}/auth/callback?next=/auth/payment`,
        },
      })
      ...
      <div className="w-full max-w-sm">
        <div className="flex flex-col gap-6">
          ...
          <Card className="border-blue-200 bg-white">
            <CardHeader>
              <CardTitle className="text-2xl text-blue-900">Sign Up</CardTitle>
            ...
            <CardContent>
              <form onSubmit={handleSignUp}>
                <div className="flex flex-col gap-6">
                  ...
                  <div className="grid gap-2">
                    <Label htmlFor="repeat-password" className="text-blue-800">Repeat Password</Label>
                    <Input
                      id="repeat-password"
                      type="password"
                      required
